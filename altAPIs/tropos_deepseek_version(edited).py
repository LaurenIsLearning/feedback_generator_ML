# -*- coding: utf-8 -*-
"""tropos_DeepSeek_version(edited).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1GEZVaN0DAnNnE1hj8hMCenVS9_vi1ZbB
...
try:
    DEEPSEEK_API_KEY = userdata.get("DeepSeek")  # Ensure this secret is set in Colab
except Exception as e:
    print("Error: Failed to retrieve DeepSeek API key. Ensure the secret 'DeepSeek' is set in Colab.")
    raise e
...
# DeepSeek API Call
    ...
    response_json = response.json()
    summary_feedback = response_json["choices"][0]["message"]["content"].strip()
